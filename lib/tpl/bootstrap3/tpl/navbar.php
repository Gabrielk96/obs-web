...
$DIR		  = '/var/www/obs-web.rs.umbc.edu/lib/tpl/bootstrap3/tpl/'
...
<nav id="dw__navbar" class="navbar <?php echo trim(implode(' ', $navbar_classes)) ?>" role="navigation">
    ...
    <div class="dw-container container<?php echo ($TPL->isFluidNavbar() ? '-fluid mx-5' : '') ?>">
        ...
        <div class="collapse navbar-collapse">
		    ...
		    #if (true){ //this enables new page widget on navbar permanently
		    if($ACT == 'show' && !$TPL->getToolMenuItem('user', 'login')){
